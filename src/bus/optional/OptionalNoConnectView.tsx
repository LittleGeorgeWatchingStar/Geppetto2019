...
interface OptionalNoConnectViewProps {
    bus: RequireBus;
    noConnect: boolean;
...
export class OptionalNoConnectView extends React.Component<OptionalNoConnectViewProps> {
    private readonly el: RefObject<HTMLLIElement>;

    constructor(props: OptionalNoConnectViewProps) {
        super(props);
