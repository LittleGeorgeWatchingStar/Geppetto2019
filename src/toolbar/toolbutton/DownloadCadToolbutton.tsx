...
interface DownloadCadToolbuttonProps extends ToolbuttonProps {
}

interface DownloadCadToolbuttonState extends ToolbuttonState {
    progress: number | null;
}

export class DownloadCadToolbutton extends Toolbutton<DownloadCadToolbuttonProps, DownloadCadToolbuttonState> {
    ...
    private fetchCompiledCadSourceJobControllerState(): DownloadCadToolbuttonState {
